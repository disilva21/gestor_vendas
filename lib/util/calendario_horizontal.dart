...
class _HorizontalWeekCalendarState extends State<HorizontalWeekCalendar> {
  ...
  isCurrentYear() {
    return DateFormat('yyyy', 'pt').format(currentWeek[0]) == DateFormat('yyyy', 'pt').format(today);
  }
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                    isCurrentYear()
                        ? DateFormat('MMMM', 'pt').format(
                            currentWeek[0],
                          )
                        : DateFormat('MMMM yyyy', 'pt').format(
                            currentWeek[0],
                          ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          "Avançar",
                          style: theme.textTheme.bodyLarge!.copyWith(
                            color: isNextDisabled() ? Colors.blue : widget.inactiveNavigatorColor ?? Colors.grey,
                            fontWeight: FontWeight.bold,
                          ),
                        ),
                        const SizedBox(
                        ...
                        Icon(
                          ...
                          size: 17,
                          color: isNextDisabled() ? theme.primaryColor : widget.inactiveNavigatorColor ?? Colors.grey,
                        ),
                      ],
                    ),
                  ),
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: DateFormat('dd-MM-yyyy', 'pt').format(listOfWeeks[ind][weekIndex]) == DateFormat('dd-MM-yyyy', 'pt').format(selectedDate)
